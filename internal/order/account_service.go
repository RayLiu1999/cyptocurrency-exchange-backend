...
func (s *Service) RegisterAnonymousUser(ctx context.Context) (*domain.User, []*domain.Account, error) {
...
func (s *Service) RechargeTestUser(ctx context.Context, userID uuid.UUID) error {
	base, quote := "BTC", "USD"
